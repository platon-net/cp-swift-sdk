...
open class ControlPanelSDKAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://setup.platon.sk/api",
    ...
    public static let shared = ControlPanelSDKAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: ControlPanelSDKAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: ControlPanelSDKAPIConfiguration = ControlPanelSDKAPIConfiguration.shared) {
        self.method = method
